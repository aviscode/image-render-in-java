...
public class ReflectionRefractionTests {
    ...
    public void trianglesTransparentSphere() {
        ...
        scene.addGeometries( //
                ...
                new Sphere(new Color(java.awt.Color.BLUE), new Material(0.2, 0.2, 30, 0.6, 0), 30, new Point3D(60, -50, 50)));
        scene.addLights(new SpotLight(new Color(700, 400, 400), new Point3D(60, -50, 0), new Vector(0, 0, 1), 1, 4E-5, 2E-7));
